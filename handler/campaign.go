...
func (h *campaignHandler) UploadImage(c *gin.Context) {
	...
	path := fmt.Sprintf("campaign-images/%s-%d-%s", uploadDate.Format("2006-01-02-150405"), userID, file.Filename)
	...
	response := helper.APIResponse("Campaign images succesfully update", http.StatusOK, "success", data)
	c.JSON(http.StatusOK, response)
}
